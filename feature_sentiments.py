...
if __name__ == "__main__":
    ...
    asins = [file.strip('.txt') for file in them]
    for asin in asins :
        review_text = open(product+'/'+asin+'.txt','r').read()
        ...
        rename_pos={'mobile':'awesome mobile','camera':'awesome camera','front camera':'good front camera','display':'good display','battery':'nice battery','performance':'great performance','sound':'good sound','speaker':'nice speakers','quality':'good quality','charging':'good charging','heating':'no heating','hanging':'No hanging'}
        rename_neg={'mobile':'worst mobile','camera':'bad camera','front camera':'bad front camera','display':'bad display','battery':'worst battery','performance':'bad performance','sound':'bad_sound','speaker':'bad_speaker','quality':'bad quality','charging':'worst charger','heating':'heating issue','hanging':'hanging problem'}
